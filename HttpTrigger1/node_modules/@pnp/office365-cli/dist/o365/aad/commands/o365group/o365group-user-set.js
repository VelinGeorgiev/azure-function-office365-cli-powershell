...
class AadO365GroupUserSetCommand extends GraphItemsListCommand_1.GraphItemsListCommand {
    get name() {
        return `${commands_1.default.O365GROUP_USER_SET}`;
    }
    get description() {
        return 'Updates role of the specified user in the specified Office 365 Group or Microsoft Teams team';
    }
    alias() {
        return [commands_2.default.TEAMS_USER_SET];
    }
