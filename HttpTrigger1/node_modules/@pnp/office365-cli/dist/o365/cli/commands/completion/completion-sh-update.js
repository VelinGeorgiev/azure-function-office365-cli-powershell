...
class CliCompletionShUpdateCommand extends AnonymousCommand_1.default {
    get name() {
        return commands_1.default.COMPLETION_SH_UPDATE;
    }
    get description() {
    ...
    commandHelp(args, log) {
        log(vorpal.find(commands_1.default.COMPLETION_SH_UPDATE).helpInformation());
        log(`  Remarks:
    ...
    time after upgrading the Office 365 CLI.
