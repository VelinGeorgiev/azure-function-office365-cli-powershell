...
class SpoThemeApplyCommand extends SpoCommand_1.default {
    ...
    commandAction(cmd, args, cb) {
        ...
        this
            ...
            if (isSharePointTheme) {
                ...
                if (json.error) {
                    cb(new Command_1.CommandError(json.error));
                    return;
                }
                else {
                    cmd.log(json.value);
  ...
  Examples:
    ...
    Apply theme to the specified site
      ${commands_1.default.THEME_APPLY} --name Contoso-Blue --webUrl https://contoso.sharepoint.com/sites/project-x

    Apply a standard SharePoint theme to the specified site
      ${commands_1.default.THEME_APPLY} --name Blue --webUrl https://contoso.sharepoint.com/sites/project-x --sharePointTheme
