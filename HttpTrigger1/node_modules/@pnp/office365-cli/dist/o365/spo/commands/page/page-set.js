...
class SpoPageSetCommand extends SpoCommand_1.default {
    ...
    commandAction(cmd, args, cb) {
        ...
        let fileNameWithoutExtension = pageName.replace('.aspx', '');
        let bannerImageUrl = '';
        let canvasContent1 = '';
        ...
        const serverRelativeFileUrl = `${Utils_1.default.getServerRelativeSiteUrl(args.options.webUrl)}/sitepages/${pageName}`;
        this
