...
class SpoListContentTypeRemoveCommand extends SpoCommand_1.default {
    get name() {
    ...
    commandAction(cmd, args, cb) {
        const removeContentTypeFromList = () => {
            ...
            if (args.options.listId) {
                ...
                requestUrl = `${args.options.webUrl}/_api/web/lists/GetByTitle('${encodeURIComponent(args.options.listTitle)}')/ContentTypes('${encodeURIComponent(args.options.contentTypeId)}')`;
            }
    ...
    located in site ${chalk.grey('https://contoso.sharepoint.com/sites/project-x')}
      ${commands_1.default.LIST_CONTENTTYPE_REMOVE} --webUrl https://contoso.sharepoint.com/sites/project-x --listId 0cd891ef-afce-4e55-b836-fce03286cccf --contentTypeId 0x010109010053EE7AEB1FC54A41B4D9F66ADBDC312A

    Remove content type with ID ${chalk.grey('0x010109010053EE7AEB1FC54A41B4D9F66ADBDC312A')}
    from the list with title ${chalk.grey('Documents')}
    located in site ${chalk.grey('https://contoso.sharepoint.com/sites/project-x')}
      ${commands_1.default.LIST_CONTENTTYPE_REMOVE} --webUrl https://contoso.sharepoint.com/sites/project-x --listTitle Documents --contentTypeId 0x010109010053EE7AEB1FC54A41B4D9F66ADBDC312A
      `);
    }
}
