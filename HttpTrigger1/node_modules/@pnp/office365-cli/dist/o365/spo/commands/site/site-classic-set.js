...
class SpoSiteClassicSetCommand extends SpoCommand_1.default {
    ...
    commandAction(cmd, args, cb) {
        ...
        this
            ...
            if (args.options.title) {
                updates.push(`<SetProperty Id="${++i}" ObjectPathId="5" Name="Title"><Parameter Type="String">${Utils_1.default.escapeXml(args.options.title)}</Parameter></SetProperty>`);
            }
    ...
    setAdmin(cmd, siteUrl, principal) {
        return new Promise((resolve, reject) => {
            this
  ...
  Remarks:
    ...
    the current state of Office 365, might take up to few minutes. If you're
