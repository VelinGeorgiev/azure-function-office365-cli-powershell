...
class SpoFolderCopyCommand extends SpoCommand_1.default {
    get name() {
        return commands_1.default.FOLDER_COPY;
    }
    get description() {
  ...
  Examples:
    ...
    another site collection
      ${commands_1.default.FOLDER_COPY} --webUrl https://contoso.sharepoint.com/sites/test1 --sourceUrl /Shared%20Documents/MyFolder --targetUrl /sites/test2/Shared%20Documents/

    Copies folder from a document library to another site in the same site
    collection
      ${commands_1.default.FOLDER_COPY} --webUrl https://contoso.sharepoint.com/sites/test1 --sourceUrl /Shared%20Documents/MyFolder --targetUrl /sites/test1/HRDocuments/
    ...
    Copy folder to a document library in another site collection. Will ignore any missing fields in the target destination and copy anyway
      ${commands_1.default.FILE_COPY} --webUrl https://contoso.sharepoint.com/sites/test1 --sourceUrl /Shared%20Documents/MyFolder --targetUrl /sites/test2/Shared%20Documents/ --allowSchemaMismatch
