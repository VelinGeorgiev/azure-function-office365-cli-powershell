...
class SpoReportSiteUsageSiteCountsCommand extends PeriodBasedReport_1.default {
    get name() {
        return `${commands_1.default.REPORT_SITEUSAGESITECOUNTS}`;
    }
    get usageEndpoint() {
  ...
  Examples:
    ...
    files for the last week
      ${commands_1.default.REPORT_SITEUSAGESITECOUNTS} --period D7

    Gets the total number of files across all sites and the number of active
    files for the last week and exports the report data in the specified path in
    text format
      ${commands_1.default.REPORT_SITEUSAGESITECOUNTS} --period D7 --output text --outputFile "siteusagesitecounts.txt"

    Gets the total number of files across all sites and the number of active
    files for the last week and exports the report data in the specified path in
    json format
      ${commands_1.default.REPORT_SITEUSAGESITECOUNTS} --period D7 --output json --outputFile "siteusagesitecounts.json"
`);
    }
}
