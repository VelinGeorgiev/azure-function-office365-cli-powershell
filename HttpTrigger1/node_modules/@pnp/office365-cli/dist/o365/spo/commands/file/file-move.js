...
class SpoFileMoveCommand extends SpoCommand_1.default {
  ...
  Examples:
    ...
    Move file to a document library in another site collection
      ${commands_1.default.FILE_MOVE} --webUrl https://contoso.sharepoint.com/sites/test1 --sourceUrl /Shared%20Documents/sp1.pdf --targetUrl /sites/test2/Shared%20Documents/

    Move file to a document library in the same site collection
        ${commands_1.default.FILE_MOVE} --webUrl https://contoso.sharepoint.com/sites/test1 --sourceUrl /Shared%20Documents/sp1.pdf --targetUrl /sites/test1/HRDocuments/
    ...
    to the recycle bin
        ${commands_1.default.FILE_MOVE} --webUrl https://contoso.sharepoint.com/sites/test1 --sourceUrl /Shared%20Documents/sp1.pdf --targetUrl /sites/test2/Shared%20Documents/ --deleteIfAlreadyExists
    ...
    Moves file to a document library in another site collection. Will ignore any missing fields in the target destination and move anyway
      ${commands_1.default.FILE_MOVE} --webUrl https://contoso.sharepoint.com/sites/test1 --sourceUrl /Shared%20Documents/sp1.pdf --targetUrl /sites/test2/Shared%20Documents/ --allowSchemaMismatch
