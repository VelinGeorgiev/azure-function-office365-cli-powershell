...
class SpoAppDeployCommand extends SpoAppBaseCommand_1.SpoAppBaseCommand {
    get name() {
    ...
    validate() {
        return (args) => {
            ...
            if (args.options.appCatalogUrl) {
                return SpoAppBaseCommand_1.SpoAppBaseCommand.isValidSharePointUrl(args.options.appCatalogUrl);
            }
            return true;
        };
    }
    commandHelp(args, log) {
        ...
        log(vorpal.find(commands_1.default.APP_DEPLOY).helpInformation());
        log(`  Remarks:
    ...
    using the ${chalk.blue(commands_1.default.APP_ADD)} command.
   
  Examples:
  
    Deploy the specified app in the tenant app catalog. Try to resolve the URL
    of the tenant app catalog automatically.
      ${commands_1.default.APP_DEPLOY} --id 058140e3-0e37-44fc-a1d3-79c487d371a3

    Deploy the specified app in the site collection app catalog 
    of site ${chalk.grey('https://contoso.sharepoint.com/sites/site1')}.
      ${commands_1.default.APP_DEPLOY} --id 058140e3-0e37-44fc-a1d3-79c487d371a3 --scope sitecollection --appCatalogUrl https://contoso.sharepoint.com/sites/site1
    ...
    Try to resolve the URL of the tenant app catalog automatically.
      ${commands_1.default.APP_DEPLOY} --name solution.sppkg

    Deploy the specified app in the tenant app catalog located at
    ${chalk.grey('https://contoso.sharepoint.com/sites/apps')}
      ${commands_1.default.APP_DEPLOY} --id 058140e3-0e37-44fc-a1d3-79c487d371a3 --appCatalogUrl https://contoso.sharepoint.com/sites/apps

    Deploy the specified app to the whole tenant at once. Features included in
    the solution will not be activated.
      ${commands_1.default.APP_DEPLOY} --id 058140e3-0e37-44fc-a1d3-79c487d371a3 --skipFeatureDeployment
