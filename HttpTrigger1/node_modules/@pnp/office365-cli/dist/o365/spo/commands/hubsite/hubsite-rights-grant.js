    ...
    commandAction(cmd, args, cb) {
        ...
        this
            ...
            const principals = args.options.principals
                .split(',')
                .map(p => `<Object Type="String">${Utils_1.default.escapeXml(p.trim())}</Object>`)
                .join('');
