...
class SpoListAddCommand extends SpoCommand_1.default {
    ...
    get listTemplateTypeMap() {
        const result = [];
        for (let template in ListTemplateType_1.ListTemplateType) {
    ...
    validate() {
        return (args) => {
            ...
            for (let i = 0; i < SpoListAddCommand.booleanOptions.length; i++) {
                ...
                if (value && !Utils_1.default.isValidBoolean(value)) {
                    return `${value} in option ${option} is not a valid boolean value`;
                }
            }
            if (args.options.templateFeatureId &&
                !Utils_1.default.isValidGuid(args.options.templateFeatureId)) {
            ...
            if (args.options.defaultContentApprovalWorkflowId &&
                !Utils_1.default.isValidGuid(args.options.defaultContentApprovalWorkflowId)) {
    ...
    in site ${chalk.grey('https://contoso.sharepoint.com/sites/project-x')}
      ${commands_1.default.LIST_ADD} --title 'DemoList' --baseTemplate Announcements --webUrl https://contoso.sharepoint.com/sites/project-x
