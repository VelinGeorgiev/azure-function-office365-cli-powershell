...
class SpoPropertyBagBaseCommand extends SpoCommand_1.default {
     ...
     */
    getFolderPropertyBag(identityResp, webUrl, folder, cmd) {
     ...
     */
    getWebPropertyBag(identityResp, webUrl, cmd) {
        const requestOptions = {
            url: `${webUrl}/_vti_bin/client.svc/ProcessQuery`,
            headers: {
                'X-RequestDigest': this.formDigestValue
    ...
    static setProperty(name, value, webUrl, formDigest, identityResp, cmd, debug, folder) {
     ...
     */
    static isNoScriptSite(webUrl, formDigest, webIdentityResp, clientSvcCommons) {
        return new Promise((resolve, reject) => {
