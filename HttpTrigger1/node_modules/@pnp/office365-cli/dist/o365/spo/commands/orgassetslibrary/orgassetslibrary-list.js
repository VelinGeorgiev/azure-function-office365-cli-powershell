...
class SpoOrgNewsSiteListCommand extends SpoCommand_1.default {
    get name() {
    ...
    commandHelp(args, log) {
        ...
        log(vorpal.find(commands_1.default.ORGASSETSLIBRARY_LIST).helpInformation());
  ...
  Examples:
    ...
    List all libraries that are assigned as asset library
      ${commands_1.default.ORGASSETSLIBRARY_LIST}
  `);
    }
}
