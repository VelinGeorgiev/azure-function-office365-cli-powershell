...
class SpoTermAddCommand extends SpoCommand_1.default {
    ...
    commandAction(cmd, args, cb) {
        ...
        this
            ...
            const termId = args.options.id || uuidv4();
            ...
            let i = 127;
            if (args.options.description) {
                properties.push(`<Method Name="SetDescription" Id="${i++}" ObjectPathId="117"><Parameters><Parameter Type="String">${Utils_1.default.escapeXml(args.options.description)}</Parameter><Parameter Type="Int32">1033</Parameter></Parameters></Method>`);
            ...
            if (args.options.localCustomProperties) {
                ...
                Object.keys(localCustomProperties).forEach(k => {
                    properties.push(`<Method Name="SetLocalCustomProperty" Id="${i++}" ObjectPathId="117"><Parameters><Parameter Type="String">${Utils_1.default.escapeXml(k)}</Parameter><Parameter Type="String">${Utils_1.default.escapeXml(localCustomProperties[k])}</Parameter></Parameters></Method>`);
                });
    ...
    validate() {
        return (args) => {
            ...
            if (args.options.parentTermId) {
                if (!Utils_1.default.isValidGuid(args.options.parentTermId)) {
    ...
    commandHelp(args, log) {
        ...
        log(vorpal.find(commands_1.default.TERM_ADD).helpInformation());
  ...
  Examples:
    ...
    specified by their names
      ${commands_1.default.TERM_ADD} --name IT --termSetName Department --termGroupName People

    Add taxonomy term with the specified name to the term group and term set
    specified by their IDs
      ${commands_1.default.TERM_ADD} --name IT --termSetId 8ed8c9ea-7052-4c1d-a4d7-b9c10bffea6f --termGroupId 5c928151-c140-4d48-aab9-54da901c7fef

    Add taxonomy term with the specified name and ID
      ${commands_1.default.TERM_ADD} --name IT --id 5c928151-c140-4d48-aab9-54da901c7fef --termSetName Department --termGroupName People

    Add taxonomy term with custom properties
      ${commands_1.default.TERM_ADD} --name IT --termSetName Department --termGroupName People --customProperties '{"Property": "Value"}'

    Add taxonomy term below the specified term
      ${commands_1.default.TERM_ADD} --name IT --parentTermId 5c928151-c140-4d48-aab9-54da901c7fef --termGroupName People
`);
    }
}
