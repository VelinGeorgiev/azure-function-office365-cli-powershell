...
class SpoCdnOriginAddCommand extends SpoCommand_1.default {
    get name() {
        return commands_1.default.CDN_ORIGIN_ADD;
    }
    get description() {
    ...
    commandAction(cmd, args, cb) {
        ...
        this
            ...
            const requestOptions = {
                ...
                body: `<Request AddExpandoFieldTypeSuffix="true" SchemaVersion="15.0.0.0" LibraryVersion="16.0.0.0" ApplicationName="${config_1.default.applicationName}" xmlns="http://schemas.microsoft.com/sharepoint/clientquery/2009"><Actions><Method Name="AddTenantCdnOrigin" Id="27" ObjectPathId="23"><Parameters><Parameter Type="Enum">${cdnType}</Parameter><Parameter Type="String">${Utils_1.default.escapeXml(args.options.origin)}</Parameter></Parameters></Method></Actions><ObjectPaths><Identity Id="23" Name="${tenantId}" /></ObjectPaths></Request>`
            };
    ...
    commandHelp(args, log) {
        ...
        log(vorpal.find(commands_1.default.CDN_ORIGIN_ADD).helpInformation());
  ...
  Examples:
    ...
    Add ${chalk.grey('*/CDN')} to the list of origins of the Public CDN
      ${commands_1.default.CDN_ORIGIN_ADD} --type Public --origin */CDN
