...
class SpoTenantSettingsSetCommand extends SpoCommand_1.default {
    ...
    commandAction(cmd, args, cb) {
        ...
        this
            ...
            for (let optionKey of Object.keys(args.options)) {
                ...
                if (['AllowedDomainListForSyncClient', 'DisabledWebPartIds'].indexOf(optionKey) > -1) {
                    ...
                    optionValue.split(',').forEach((value) => {
                        valuesXml += `<Object Type="Guid">{${Utils_1.default.escapeXml(value)}}</Object>`;
                    });
            ...
            const requestOptions = {
                ...
                body: `<Request AddExpandoFieldTypeSuffix="true" SchemaVersion="15.0.0.0" LibraryVersion="16.0.0.0" ApplicationName="${config_1.default.applicationName}" xmlns="http://schemas.microsoft.com/sharepoint/clientquery/2009"><Actions>${propsXml}</Actions><ObjectPaths><Identity Id="7" Name="${tenantId}" /></ObjectPaths></Request>`
            };
  ...
  Examples:
    ...
    Sets single tenant global setting
      ${commands_1.default.TENANT_SETTINGS_SET} --UserVoiceForFeedbackEnabled true

    Sets multiple tenant global settings at once
      ${commands_1.default.TENANT_SETTINGS_SET} --UserVoiceForFeedbackEnabled true --HideSyncButtonOnODB true --DisabledWebPartIds c9b1909e-901a-0000-2cdb-e91c3f46320a,c9b1909e-901a-0000-2cdb-e91c3f463201
  `);
    }
}
