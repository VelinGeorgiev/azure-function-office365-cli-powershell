...
class OutlookSendmailCommand extends GraphCommand_1.default {
    get name() {
        return `${commands_1.default.OUTLOOK_MAIL_SEND}`;
    }
    get description() {
        return 'Sends e-mail on behalf of the current user';
    }
    alias() {
        return [commands_1.default.OUTLOOK_SENDMAIL];
    }
    ...
    commandAction(cmd, args, cb) {
        let bodyContents = args.options.bodyContents;
    ...
    validate() {
        return (args) => {
            ...
            if (args.options.bodyContentsFilePath) {
                const fullPath = path.resolve(args.options.bodyContentsFilePath);
